...
const insertIntoDB = (data) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (result) {
        yield redis_1.RedisClient.publish(academicDepartment_constants_1.EVENT_ACADEMIC_DEPARTMENT_CREATED, JSON.stringify(result));
    }
    return result;
});
    ...
    if (Object.keys(filterData).length > 0) {
        andConditions.push({
            AND: Object.keys(filterData).map(key => {
                if (academicDepartment_constants_1.academicDepartmentRelationalFields.includes(key)) {
                    return {
                        [academicDepartment_constants_1.academicDepartmentRelationalFieldsMapper[key]]: {
                            id: filterData[key],
                        },
                    };
                }
...
const updateOneInDB = (id, payload) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (result) {
        yield redis_1.RedisClient.publish(academicDepartment_constants_1.EVENT_ACADEMIC_DEPARTMENT_UPDATED, JSON.stringify(result));
    }
    return result;
});
const deleteByIdFromDB = (id) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (result) {
        yield redis_1.RedisClient.publish(academicDepartment_constants_1.EVENT_ACADEMIC_DEPARTMENT_DELETED, JSON.stringify(result));
    }
    return result;
});
