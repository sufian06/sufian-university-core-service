...
const insertIntoDB = (academicSemesterData) => __awaiter(void 0, void 0, void 0, function* () {
    if (academicSemester_constants_1.academicSemesterTitleCodeMapper[academicSemesterData.title] !==
    ...
    if (result) {
        yield redis_1.RedisClient.publish(academicSemester_constants_1.EVENT_ACADEMIC_SEMESTER_CREATED, JSON.stringify(result));
    }
    return result;
});
...
const updateOneInDB = (id, payload) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (result) {
        yield redis_1.RedisClient.publish(academicSemester_constants_1.EVENT_ACADEMIC_SEMESTER_UPDATED, JSON.stringify(result));
    }
    return result;
});
const deleteByIdFromDB = (id) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (result) {
        yield redis_1.RedisClient.publish(academicSemester_constants_1.EVENT_ACADEMIC_SEMESTER_DELETED, JSON.stringify(result));
    }
    return result;
});
