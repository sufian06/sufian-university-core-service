...
router.patch('/:id', (0, auth_1.default)(user_1.ENUM_USER_ROLE.SUPER_ADMIN, user_1.ENUM_USER_ROLE.ADMIN), (0, validateRequest_1.default)(building_validations_1.BuildingValidations.update), building_controller_1.BuildingController.updateOneInDB);
