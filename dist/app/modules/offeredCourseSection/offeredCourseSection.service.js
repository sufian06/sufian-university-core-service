...
const insertIntoDB = (payload) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const offeredCourseSectionData = yield prisma_1.default.offeredCourseSection.findFirst({
        where: {
            offeredCourse: {
                id: data.offeredCourseId,
            },
    ...
    if (offeredCourseSectionData) {
        throw new ApiError_1.default(http_status_1.default.BAD_REQUEST, 'Course section already exist!');
    }
    ...
    if (Object.keys(filterData).length > 0) {
        andConditions.push({
            AND: Object.keys(filterData).map(key => {
                if (offeredCourseSection_constants_1.offeredCourseSectionRelationalFileds.includes(key)) {
                    return {
