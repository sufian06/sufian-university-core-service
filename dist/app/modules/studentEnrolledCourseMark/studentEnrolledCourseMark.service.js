...
const updateStudentMarks = (payload) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result = studentEnrolledCourseMark_utils_1.StudentEnrolledCourseMarkUtils.getGradeFromMarks(marks);
    const updateStudentMarks = yield prisma_1.default.studentEnrolledCourseMark.update({
        where: {
            id: studentEnrolledCourseMarks === null || studentEnrolledCourseMarks === void 0 ? void 0 : studentEnrolledCourseMarks.id,
        },
        data: {
            marks,
            grade: result.grade,
...
const updateFinalMarks = (payload) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result = studentEnrolledCourseMark_utils_1.StudentEnrolledCourseMarkUtils.getGradeFromMarks(totalFinalMarks);
    ...
    const academicResult = yield studentEnrolledCourseMark_utils_1.StudentEnrolledCourseMarkUtils.calcCGPAandGrade(grades);
