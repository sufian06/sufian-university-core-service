...
const set = (key, vlaue, options) => __awaiter(void 0, void 0, void 0, function* () {
    yield redisClient.set(key, vlaue, options);
});
...
const setAccessToken = (userId, token) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const expiresTime = config_1.default.redis.expires_in || '10000';
    yield redisClient.set(key, token, { EX: Number(expiresTime) });
});
