/*
  ...
  - You are about to drop the column `couseId` on the `offered_courses` table. All the data in the column will be lost.
...
*/
-- DropForeignKey
ALTER TABLE "offered_courses" DROP CONSTRAINT "offered_courses_couseId_fkey";

-- AlterTable
ALTER TABLE "offered_courses" DROP COLUMN "couseId",
